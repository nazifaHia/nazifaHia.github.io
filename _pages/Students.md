...
<p class="mentorship-summary">
  Currently Working on 4 ongoing research projects across three labs — CARS, BARTA, and DULL-IIT.
</p>
...
<div class="mentorship-columns">
  ...
  <div class="mentorship-col mentors-col">
    <h3 class="lab-heading">My Mentors</h3>

    <div class="mentor-card-compact">
      <img src="/images/Naushin.jpg" class="mentor-photo-sm">
      <div class="mentor-info">
        ...
        <div class="mentor-connection">Mam, guides my domain adaptation and edge AI research.</div>
      </div>
    </div>

    <div class="mentor-card-compact">
      <img src="/images/Sumon.jpg" class="mentor-photo-sm">
      <div class="mentor-info">
    ...
    <div class="mentor-card-compact">
      <img src="/images/Shebuti.jpeg" class="mentor-photo-sm">
      <div class="mentor-info">
        <div class="mentor-name">Dr. Shebuti Rayana</div>
        <div class="mentor-title">Assistant Professor, State University of New York at Old Westbury, USA</div>
        <div class="mentor-tag collab">Mentor & Reference</div>
        <div class="mentor-connection">Working in LLM projects with mam</div>
      </div>
    </div>

    <div class="mentor-card-compact">
      <img src="/images/Sajib.jpeg" class="mentor-photo-sm">
      <div class="mentor-info">
        <div class="mentor-name">Dr. Sajib Mistry</div>
        <div class="mentor-title">Associate Professor, Curtin University, Australia</div>
        <div class="mentor-tag collab">Mentor & Reference</div>
