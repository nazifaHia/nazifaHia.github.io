...
<div class="exp-page-title">Team & Mentors</div>
...
<nav class="mentorship-nav">
  <a href="#mentees">Mentees</a> · <a href="#mentors">My Mentors</a>
</nav>

<h3 class="lab-heading" id="mentees">Mentees & Collaborators</h3>
...
<h3 class="lab-heading" id="mentors">My Mentors</h3>
...
<div class="mentor-row">
  <div class="mentor-card-compact">
    ...
    <div class="mentor-info">
      ...
      <div class="mentor-connection">Guides my domain adaptation and edge AI research at CARS.</div>
    </div>
  </div>
  <div class="mentor-card-compact">
...
<div class="mentor-row">
  <div class="mentor-card-compact">
    ...
    <div class="mentor-info">
      ...
      <div class="mentor-connection"><!-- fill in: co-supervised project + period --></div>
    </div>
  </div>
  <div class="mentor-card-compact">
    ...
    <div class="mentor-info">
      ...
      <div class="mentor-title"><!-- fill in institution --></div>
      <div class="mentor-tag collab">Collaborator, Former Mentor</div>
      <div class="mentor-connection"><!-- fill in: co-supervised project + period --></div>
    </div>
  </div>
